...
cc.Class({
    ...
    start () {
        ...
        //鼠标左键按下系统事件
        cc.Canvas.instance.node.on(cc.Node.EventType.TOUCH_START, this.onMouseDown, this);
        //鼠标左键抬起系统事件
        cc.Canvas.instance.node.on(cc.Node.EventType.TOUCH_END, this.onMouseUp, this);
        //白球停止的自定义事件
