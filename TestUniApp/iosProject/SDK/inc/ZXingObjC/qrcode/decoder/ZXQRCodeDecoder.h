 ...
 * @return nil if error correction fails
 */
- (ZXDecoderResult *)decode:(NSArray *)image hints:(ZXDecodeHints *)hints error:(NSError **)error autoDecodeCharset:(BOOL)autoDecodeCharset;

- (ZXDecoderResult *)decodeMatrix:(ZXBitMatrix *)bits error:(NSError **)error;

- (ZXDecoderResult *)decodeMatrix:(ZXBitMatrix *)bits hints:(ZXDecodeHints *)hints error:(NSError **)error autoDecodeCharset:(BOOL)autoDecodeCharset;
