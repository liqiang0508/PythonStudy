...
const dom = new JSDOM(`<body>
  ...
  tac='i)69kexbogms!i$13eys\"0,<8~z|\x7f@QGNCJF[\\\\^D\\\\KFYSk~^WSZhg,(lfi~ah\`{md\"inb|1d<,%Dscafgd\"in,8[xtm}nLzNEGQMKAdGG^NTY\x1ckgd\"inb<b|1d<g,&TboLr{m,(\x02)!jx-2n&vr$testxg,%@tug{mn ,%vrfkbm[!cb|'
  !function(t) {
  if (t.__M = t.__M || {},
    !t.__M.require) {
